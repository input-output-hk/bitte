    ...
    */
    ...
    data.vault_policy_document.admin.rule = let
      rules = [
        ...
        {
          path = "auth/github-employees/config";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
          path = "auth/github-employees/map/teams/*";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
          path = "auth/github-terraform/config";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
          path = "auth/github-terraform/map/teams/*";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
        ...
        {
          path = "sys/auth/github-employees";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
          path = "sys/auth/github-employees/config";
          capabilities = [ c r ];
          description = "";
        }
        {
          path = "sys/auth/github-terraform";
          capabilities = [ c r u d l s ];
          description = "";
        }
        {
          path = "sys/auth/github-terraform/config";
          capabilities = [ c r ];
          description = "";
        }
        {
