...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    owner = "grafana";
    repo = "grafana";
    sha256 = "sha256-Ne81BC9IBVHIzrz1bX23URSgzWwVcHMltNzL6o1Tk9g=";
  };

  srcStatic = fetchurl {
    url = "https://dl.grafana.com/oss/release/grafana-${version}.linux-amd64.tar.gz";
    sha256 = "sha256-Baqih0sVLSUpZqPccLClOUiuYnulprKf5g7BTRqMy/M=";
  };

  vendorSha256 = "sha256-5xrda0nYV5OMaRpc+eDVgOEWIleQKU/lxzfty87rWgM=";
