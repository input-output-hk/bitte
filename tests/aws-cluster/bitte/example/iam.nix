          ...
          policies =
            ...
            s3Secrets // s3Cache // {
              ...
              assumeRole = {
                effect = "Allow";
                resources = [
                  cluster.coreNodes.core-1.iam.instanceProfile.tfArn
                  cluster.coreNodes.core-2.iam.instanceProfile.tfArn
                  cluster.coreNodes.core-3.iam.instanceProfile.tfArn
                ];
